...
class ULensDistortionBlueprintLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure, Category = "GPShader | Lens Distortion")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "GPShader | Lens Distortion", meta = (WorldContext = "WorldContextObject"))
	...
	UFUNCTION(BlueprintPure, meta=(DisplayName = "Equal (LensDistortionCameraModel)", CompactNodeTitle = "==", Keywords = "== equal"), Category = "GPShader | Lens Distortion")
	static bool EqualEqual_CompareLensDistortionModels(
		const FGPShaderCameraModel& A,
		const FGPShaderCameraModel& B)
	{
		return A == B;
	}

	/* Returns true if A is not equal to B (A != B) */
	UFUNCTION(BlueprintPure, meta = (DisplayName = "NotEqual (LensDistortionCameraModel)", CompactNodeTitle = "!=", Keywords = "!= not equal"), Category = "GPShader | Lens Distortion")
