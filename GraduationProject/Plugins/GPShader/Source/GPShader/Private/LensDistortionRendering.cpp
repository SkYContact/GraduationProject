...
/**
 * Internal intermediary structure derived from FGPShaderCameraModel by the game thread
 * to hand to the render thread.
 */
struct FCompiledCameraModel
{
	/** Orignal camera model that has generated this compiled model. */
	FGPShaderCameraModel OriginalCameraModel;
...
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationVS, TEXT("/Plugin/GPShader/Private/MyShader.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationPS, TEXT("/Plugin/GPShader/Private/MyShader.usf"), TEXT("MainPS"), SF_Pixel)
...
FVector2D FGPShaderCameraModel::UndistortNormalizedViewPosition(FVector2D EngineV) const
{
...
float FGPShaderCameraModel::GetUndistortOverscanFactor(
...
void FGPShaderCameraModel::DrawUVDisplacementToRenderTarget(
	UWorld* World,
